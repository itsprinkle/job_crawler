...
#DUPEFILTER_CLASS ="zhilian_spider.dupefilters.SeenURLFilter"
...
ITEM_PIPELINES = {
    #'zhilian_spider.pipelines.JsonPipeline': 300,
    'zhilian_spider.pipelines.SQLStorePipeline': 310,
}

# Enable or disable spider middlewares
# See http://scrapy.readthedocs.org/en/latest/topics/spider-middleware.html
#SPIDER_MIDDLEWARES = {
#    'zhilian_spider.middlewares.MyCustomSpiderMiddleware': 543,
#}
...
DOWNLOADER_MIDDLEWARES = {
  ...
  #   'zhilian_spider.proxymiddlewares.ProxyMiddleware': 100,
  #   'zhilian_spider.rotate_useragent.RotateUserAgentMiddleware':90,
}
...
#ITEM_PIPELINES = {
#    'zhilian_spider.pipelines.SomePipeline': 300,
#}
